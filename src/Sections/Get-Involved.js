...
import { Box, Paper, Grid, Typography, Card, CardContent, Slide, Divider } from "@mui/material";
        ...
        <Box sx={{background:'linear-gradient(to left bottom, #004FFF, #005 70%)', pt:5, pb:2}}>
            <Paper sx={{my:{xs:2, md:15}, mx:{xs:2, md:7}, pt: 4, background:'linear-gradient(to left bottom, #000, #fff 180%)'}}>
                <Grid container justifyContent='center' direction='column' alignItems='center'>
                    <Grid item>
                        <Typography variant='h3' color='silver'>{'Ways to get Involved...'.toLocaleUpperCase()}</Typography>
                    </Grid>
