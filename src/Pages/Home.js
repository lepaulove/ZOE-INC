...
const Home = (props) => {
    ...
    return(
            ...
            {/* <Card sx={{backgroundColor:'#262A34', mt:2, borderRadius:3}}>
                <CardContent sx={{px:1, py:.5}}>
                    ...
                    <Typography color='#FFF' fontFamily='monospace' lineHeight={1} fontSize={15}>
                        ZOE INC and ASSOCIATES® is a Community Driven Organization that works with teens ages 15 - 22 or parent/guardians of parenting teens to provide them with mentoring guidance and resources to help make their parenting journey a success.
                    </Typography>
                </CardContent>
            </Card> */}
                </Grid>
                    ...
                    <Typography color='#FFF' fontSize={25} fontWeight='bold'>CONTACT US</Typography>
                        <Grid item container direction='column' sx={{backgroundColor:'#36BAFE', borderRadius:3, pt:3}}>
                            <Grid item container  rowSpacing={3.5} sx={{px:3, pb:3}}>
                                <Grid item><Typography color='#FFF'>Email</Typography><Typography color='#FFF' fontWeight={700}>zoecounselinggroup@gmail.com</Typography></Grid>
                                <Grid item><Typography color='#FFF'>{`Phone (By Appointment Only)`}</Typography><Typography color='#FFF' fontWeight={700}>229-789-3300</Typography><Typography color='#FFF' fontWeight={700}>229-789-4400</Typography></Grid>
                                <Grid item><Typography color='#FFF'>24Hour Crisis Line</Typography><Typography color='#FFF' fontWeight={700}>229-431-0217</Typography></Grid>
                                <Grid item><Typography color='#FFF'>Address</Typography><Typography color='#FFF' fontWeight={700}>Microbusines Enterprise Center, 230 South Jackson St. Suite 158, Albany, Geotgia 31701</Typography></Grid>
                        </Grid>
        ...
        // <div style={{backgroundColor:'#181824'}}>
        //     <div ref={historyRef}>
        //         <History />
        //     </div>
        //     <div ref={purposeRef}>
